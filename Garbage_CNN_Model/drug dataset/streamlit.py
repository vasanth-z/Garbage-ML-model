...
# Load trained model
model = tf.keras.models.load_model("waste_drugs_classification.h5")

# Define class labels
class_labels = ["Illegal Drugs", "Legal Drugs"]

# Streamlit UI
st.title("♻️ Drug Classification - Illegal Drugs vs Legal Drugs")
...
def classify_image(img):
    ...
    predicted_class_index = np.argmax(prediction)  # Get highest probability class index
